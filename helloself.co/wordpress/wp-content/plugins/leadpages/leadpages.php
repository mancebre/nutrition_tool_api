...
class LeadPages {
    ...
    function check_root() {
        ...
        if ($front === false && $wg === false) return;
    ...
    function load_custom_wp_admin_style() {
        ...
        wp_register_script('leadpages_admin', $admin_url . 'js/admin_leadpages.js' . $v, array('leadpages_jquery', 'leadpages_bootstrap'));
    ...
    function leadpages_post_register() {
        ...
        $args = array(
            ...
            'hierarchical' => false,
            'has_archive' => false,
            'supports' => array('leadpages_my_selected_page', 'leadpages_slug', 'leadpages_name', 'leadpages_url'),
...
EOT;
    ...
    function load_my_pages() {
        if (self::$_mypages != false) {
            return array($_mypages, 'Everything is good!');
        }
...
?>
    ...
    <div class="bootstrap-wpadmin">
        <input type="hidden" name="leadpages_meta_box_nonce" value="<?php echo wp_create_nonce(basename(__FILE__)) ?>" />
        <div class="row-fluid form-horizontal">
            <br/>
            <div class="control-group">
                <label class="control-label">LeadPage type</label>
                <div class="controls">
                    <div class="btn-group multichoice subsection" data-subsection="leadpages_url" data-target="leadpages-post-type">
                    ...
                    <a class="leadpages-help-ico leadpages-check-style" rel="popover" data-original-title="LeadPage type" data-content="
                    ...
                    ">&nbsp;</a>
                    <input type="hidden" name="leadpages-post-type" class="leadpages-post-type" value="<?php echo $leadpages_post_type ?>" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="leadpages_my_selected_page" id="leadpages_my_selected_page" class="input-xlarge">
            ...
            <?php } ?>
                    ...
                    <a data-content="Select one of the LeadPages that you've created on &lt;strong&gt;http://my.leadpages.net/&lt;/strong&gt;" data-original-title="LeadPage to be displayed" rel="popover" class="leadpages-help-ico">&nbsp;</a>
                </div>
            </div>
            ...
            <div style="display:none" class="subsection_leadpages_url control-group">
                ...
                <div class="controls <?php if ($missing_slug) echo 'lp-error' ?>" id="leadpages-wp-path">
                    <div class="input-prepend">
                        <span class="add-on"><?php echo site_url() ?>/</span><input type="textbox" class="input-xlarge" id="leadpages_slug" name="leadpages_slug" value="<?php echo $meta_slug ?>" />
                    </div>
                    <a class="leadpages-help-ico" rel="popover" data-original-title="LeadPage url" data-content="Pick your own url based on your WordPress site. It will work as if the selected LeadPage was a &quot;Page&quot; on your site.">&nbsp;</a>
                    <?php if ($missing_slug) { ?>
                    <label for="leadpages_slug" generated="true" class="error" style="color:#ff3300" id="lp-error-path">Valid path is required.</label>
                    <?php } ?>
                </div>
            </div>
            ...
            <div style="display:none" class="control-group" id="wg-options">
                ...
                <div class="controls">
                    ...
                    <a class="leadpages-help-ico leadpages-check-style" rel="popover" data-original-title="WelcomeGate redirect method" data-content="&lt;strong&gt;HTTP&lt;/strong&gt; redirect is recommended in most cases. Occasionally  with some caching plugins or systems, &lt;strong&gt;JavaScript&lt;/strong&gt; redirect might be better choice.">&nbsp;</a>
                    <input type="hidden" name="leadpages_redirect_method" class="leadpages_redirect_method" value="<?php echo $redirect_method ?>" />
                </div>
            </div>
            ...
            <?php } ?>
                <a href="<?php echo admin_url('edit.php?post_type=leadpages_post') ?>" type="submit" class="btn">Back</a>
            </div>
        </div>
    </div>
<?php }
